...
---
 ...
 Paid Internship Opportunity – React.js (Next.js)

We’re looking for a passionate intern skilled in React.js (Next.js) & Redux Toolkit. Knowledge of Node.js & Express is a plus.
📍 Location: Banani, Dhaka (On-site)
🕒 Immediate Joining

📩 To apply, send your CV & portfolio to connect@thinkcrypt.dev
🔗 Find out more: https://thinkcrypt.dev
