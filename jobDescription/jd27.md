...
```markdown
### 85.03 `🏢 Company Name — Job Title - onsite/remote - date with foramt: 31/12/25 - BDT salary`
...
VISAThing is hiring for Multiple positions.

Position: 
1) Front End (Developer)
2) Front End (Intern) 

Location: Level 05 TAA- 111, Tropical Maanco Tower, 112 Gulshan Badda Link Rd, Dhaka 1212

Salary for Front End (Intern)     10K
Salary for Front End (Developer)    15-25K (at probation)

Job Type: Onsite
Technologies/Requirements    - Solid understanding of core web technologies: HTML5, CSS3, and JavaScript (ES6+)


Hands-on experience with React.js and Next.js
Strong proficiency in Tailwind CSS and responsive design principles
Working knowledge of TypeScript for scalable and maintainable code
Familiarity with UI libraries such as Ant Design (antd)
Good grasp of state management tools like Redux Toolkit and TanStack Query (React Query)
Understanding of RESTful APIs and API integration
Knowledge of Git and version control workflows (GitHub, GitLab)
Awareness of front-end performance optimization techniques and basic SEO best practices
...
N.B: Do not apply If you are not efficient with NextJS and TypeScript.

Interested candidates, please fill out the form:

https://forms.gle/6VuK6zizCWZM7uRs5
