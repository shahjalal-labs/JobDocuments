...
---
 ...
 ABSS is Hiring: Frontend/Nodejs Developer (Intern/Experienced) – Remote
We're looking for Frontend/Nodejs Developer (2 experienced & 2 intern) to join our team — whether you're just starting out or have some experience under your belt!
What We're Looking For:

    Solid knowledge of HTML, CSS, JavaScript
    Experience with React and Next.js
    Familiarity with React-based libraries like Redux
    Basic understanding of APIs and some exposure to Node.js
    Willingness to learn backend technologies
    Someone who is trustworthy, responsible, and eager to grow

About Us:

    We're a remote-first team
    We believe in flexibility, ownership, and self-motivation
    You’ll work in a collaborative, supportive environment with room to grow

Compensation:

    $150 - $175 per month (for experieced based on experience and skill level)
    $75 per month (for Intern)

If you're looking for a place to learn, grow, and take responsibility for your work, we’d love to hear from you!

Send your resume to info@abss.tech

Visit us at: www.abss.tech
