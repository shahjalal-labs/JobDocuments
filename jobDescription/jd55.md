...
---
 ...
 Job Opportunity: React JS Developer
We are hiring a talented React JS Developer to join our dynamic team! 💻✨
👨‍💻 Position: React JS Developer
🕒 Experience: 1–2 years
🔑 Key Responsibilities:
✅ Develop user-friendly web applications using React JS
✅ Integrate RESTful APIs and manage third-party services
✅ Collaborate with backend developers & designers to deliver high-quality projects
✅ Ensure application performance, responsiveness & scalability
🎯 Requirements:
🔹 Proficiency in React JS & modern JavaScript (ES6+)
🔹 Experience with REST API integration
🔹 Basic knowledge of state management (Redux / Context API preferred)
🔹 Ability to work in a collaborative environment
🏢 Job Type: Offline (On-site)
💰 Salary: 25,000 BDT + Incentives
🎁 Facilities: Attractive benefits & career growth opportunities
📩 Apply Now: Send your CV to monirahammadit@gmail.com
📍 Location: Uttara, Sector-9, Road 3F, House 18, Dhaka, Bangladesh
@highlight
