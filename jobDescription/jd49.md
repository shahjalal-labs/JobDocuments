...
```markdown
### 95.08 `🏢 Company Name — Job Title - onsite/remote - date with foramt: 31/12/25 - BDT salary`
...
We're hiring a Full-Stack Engineer, 3 month contract, Dhaka hybrid! 🚀
Stealth startup seeking a mid-level developer who loves building with modern tech. Remote work with weekly team meetings.

    Build with Next.js 14, React 18, Node or Nest
    Deploy with Docker to Digital Ocean or AWS
    Remote work, weekly in-person syncs in Dhaka
    Office hours 10:00 to 6:00 PM
    You have 2+ years with Next.js 13+, APIs, TypeScript, Git
    Bonus, Python for simple inference APIs, FastAPI or Flask

Looking for: 2+ years experience, conventional commits, startup mindset
Interested? Fill out the application form. https://lnkd.in/gEreZVyH
#Dhaka #FullStackDeveloper #NextJS #React #StartupJobs #TechJobs #Bangladesh
