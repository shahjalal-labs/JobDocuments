...
Job Position:  Full Stack Developer Intern (MERN + Flutter)
...
Responsibilities:
-Assist in building modern web applications using MERN stack
-Develop and test mobile apps with Flutter
-Work with REST APIs and integrate them with frontend & mobile apps
-Collaborate with the team using Git/GitHub
-Debug, test, and fix issues under supervision
--Prepare documentation and report progress to mentors
Required Skills:
-Basic understanding of React.js (components, hooks, state management)
-Knowledge of Node.js + Express (basic CRUD APIs)
-Familiarity with MongoDB
-Flutter basics: UI widgets, state management, API calls
-Experience with Git/GitHub
-Strong passion for learning and problem-solving
What We’re Looking For
-0–1.5 years of experience (or project-based portfolio)
-Basic knowledge of React, Node.js, and databases
-Eagerness to learn and improve every day
-Teamwork and clear communication skills
-Working Hours 2:00 PM – 10:00 PM (Bangladesh Time)
-Remote flexibility with structured collaboration.
Benefits
-Monthly Stipend: 13,000 BDT
-Hands-on experience with real-world projects
-Mentorship from experienced developers
-Internship Certificate after completion
-High-performing interns may receive a full-time job offer
Apply Link: [https://www.brightfuturesoft.com/.../68b5a1f5b37257b08fdc...](https://www.brightfuturesoft.com/.../68b5a1f5b37257b08fdc...)
