...
```markdown
### 96.02 `🏢 Company Name — Job Title - onsite/remote - date with foramt: 31/12/25 - BDT salary`
...
Location: Aqua Tower, Mohakhali
Schedule: Full-Time (9:00 AM – 6:00 PM) - onsite
Salary: BDT 20,500 – 40,000 (Negotiable) + Performance Bonuses
Skills: Node, Mongoose, Ts, RTK Query, React, Next
Interested candidates are requested to send their resume to abujakaria.ph@gmail.com
