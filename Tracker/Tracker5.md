...
### 100.09 `🏢 CodeItDevs — Full Stack Developer - remote - 17/09/26 - BDT Negotiable`

<pre><code>
📅 Applied On: 17/09/26
💰 Stipend/Salary : Not mentioned ≈ Negotiable BDT / Monthly
⏰ Hours: Bangladesh Time (GMT+6) → Pakistan Time (GMT+5)
🧰 Stack: JavaScript, TypeScript, React, Next.js, Node.js, REST APIs, Cloud, AI Automation
❌ Lack Stack: python, gcp, azure
📆 Interview Date: Not yet scheduled
🌐 Location: Remote, Pakistan (GMT+5)
🧭 Platform: Email application
⏳ Status: 🟡 Pending
📞  Follow-Up way:  info@codeitdevs.com
</code></pre>

🔗 [Company Website](https://codeitdevs.com) `https://codeitdevs.com` <br />
🔗 [Job Link](N/A) `link: N/A...`

---

### 101.10 `🏢 Ignisync Lab — Front-End Developer - remote - 17/09/26 - BDT Negotiable`

<pre><code>
📅 Applied On: 17/09/26
💰 Stipend/Salary : Not mentioned ≈ Negotiable BDT / Monthly
⏰ Hours: Bangladesh Time (GMT+6) → Flexible Remote
🧰 Stack: React.js, Next.js, TypeScript, Tailwind CSS, Figma-to-Code, Charts, Component Architecture
❌ Lack Stack: Storybook, Jest/Cypress
📆 Interview Date: Not yet scheduled
🌐 Location: Remote (Global / Timezone Flexible)
🧭 Platform: Email application
⏳ Status: 🟡 Pending
📞  Follow-Up way:  contact@ignisynclab.com
</code></pre>

🔗 [Company Website](https://ignisynclab.com) `https://ignisynclab.com` <br />
🔗 [Job Link](N/A) `link: WE’RE HIRING | FRONT-END DEVE...`
